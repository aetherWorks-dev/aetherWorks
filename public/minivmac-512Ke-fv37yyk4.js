var emulator = (() => {
  ...
  return async function(moduleArg = {}) {
    ...
    var HEAP8, HEAPU8, HEAP16, HEAP32, HEAPU32, HEAPF64;
    ...
    if (Module["locateFile"]) {
      ...
      wasmBinaryFile = new URL("/minivmac-512Ke-BxAX5jJt.wasm", import.meta.url).href;
    }
    ...
    var ASM_CONSTS = {
      ...
      75922: ($0, $1) => {
        return workerApi.enqueueAudio($0, $1);
      },
      75965: ($0) => {
    ...
    Module["___start_em_js"] = 76957;
    Module["___stop_em_js"] = 77247;
    Module["FS"] = FS;
