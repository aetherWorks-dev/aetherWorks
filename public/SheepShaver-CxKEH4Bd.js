var emulator = (() => {
  ...
  return async function(moduleArg = {}) {
    ...
    if (Module["locateFile"]) {
      ...
      wasmBinaryFile = new URL("/SheepShaver-CQPBdQGu.wasm", import.meta.url).href;
    }
    ...
    var ASM_CONSTS = {
      ...
      186228: ($0) => {
        return workerApi.etherRead($0, 1514);
      },
      186270: ($0, $1) => {
      ...
      187843: ($0) => {
        return workerApi.disks.isFixedDisk($0);
      },
      187887: ($0) => {
    ...
    Module["dynCall_iiiji"] = (a0, a1, a2, a3, a4, a5) => (Module["dynCall_iiiji"] = wasmExports["dynCall_iiiji"])(a0, a1, a2, a3, a4, a5);
    Module["dynCall_ji"] = (a0, a1) => (Module["dynCall_ji"] = wasmExports["dynCall_ji"])(a0, a1);
    Module["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (Module["dynCall_jiji"] = wasmExports["dynCall_jiji"])(a0, a1, a2, a3, a4);
    Module["___start_em_js"] = 187918;
    Module["___stop_em_js"] = 188254;
    Module["FS"] = FS;
    var calledRun;
